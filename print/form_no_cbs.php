...
<body >
	<div style="height:100%; width:100%;"> <!-- fix page break -->
        <table style="width:99%;height:99%;border-collapse:collapse;margin-left:0%;"  cellpadding="0" cellspacing="0">
                        ...
                        <table class="header padding" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0"> <!-- table 1-->
                            ...
                            <tr>
                                ...
                                <?php
                                    if (!empty($remarkNhancap) ) {
                                        echo '<td colspan="2" rowspan="2" class="remark-nhan-cap" style="letter-spacing:0.1px;font-family: Impact;">';
                                            echo $remarkNhancap;
                                        echo '</td>';
                                    } else {
                            ...
                            <tr>
                                ...
                                <td>&nbsp;<span style="text-align:center; font-size:20px;font-weight:bold;"><?php 
                                        ...
                                        $result_vn_replacement = mysqli_query($conn2,$sql_vn_replacement);
                ...
                <td style="padding:0px;" class="<?php echo $non_border;?>">
                    <table class="padding" style="width:100%;height:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
						...
						<tr class="so_luong_po">
                            ...
                            <td colspan="9" rowspan="4" style="border: none;" >
                                <div style="border: 1px solid black; margin:2px 0; padding:5px; width:97%; height:120px; text-align:left; ">
                                    <!-- Mỗi dòng bao gồm 1 tiêu đề (trái) và 1 nội dung (phải) -->
                                    <div style="width: 100%; height: 30px; line-height:30px; ">
                                        <div style="float: left; width:30%; font-weight: bold;">
                                            Cut Machine: 
                                        </div>
                                        <div style="float: right; width:70%;">
                                            <?php echo $CUT_MACHINE; ?>    
                                        </div>
                                    </div>
						...
						<tr class="so_luong_po" >
							...
							<!-- <td colspan="9" >Màu 4</td>  -->
                        </tr>
						<!-- vat tu thuc te -->
						<tr class="so_luong_po">
                            <td	colspan="1" class="<?php echo $non_border;?> <?php echo $a_pt10_b;?>">Tỉ lệ bù hao theo PO#:</td><td colspan="1" class="<?php echo $non_border;?> <?php echo $a_pt10_b;?>">  <?php echo $TI_LE_BU_HAO;?> </td><td colspan="1" class="<?php echo $non_border;?> <?php echo $a_pt6_b;?>"></td><td class="<?php echo $non_border;?>" style="width:5%">&nbsp;</td>
                            <td colspan="5" class="<?php echo $non_border;?>" style="text-align:left;font-weight:bold;"><?php echo !empty($SHIP_TO_CUSTOMER) ? ("Ship to:" . html_entity_decode($SHIP_TO_CUSTOMER, ENT_QUOTES) ) : ''; ?> </td>
                        </tr>
						<!-- so luong con nhan-->
						<tr style="height:7%">
            ...
            <tr style="height:15%">
            <td colspan="" class="<?php echo $non_border;?>">
            <div style="text-align:left;font-size:14px;padding-top:8px;">Ghi chú: <?php echo $PACKING_INSTRUCTIONS; ?> </div>
                <?php 
                    echo '<div class="bottom-remark-box">';
                        ...
                        echo '<div class="bottom-remark-left"> ';
                            ...
                            if (!empty($remark_bo_coc_200pcs ) ) {
                                echo '<div class="bottom_remark_color-2" >';
                                    echo $remark_bo_coc_200pcs;
                                echo '</div>';
                            }

                            if (!empty($remark_20191212 ) ) {
                                echo '<div class="bottom_remark_color">';
                                    echo $remark_20191212;
                                echo '</div>';
                            }

                            if (!empty($remark_SPECIAL_REQUEST ) ) {
                                echo '<div class="bottom_remark_color-2" >';
